...
\documentclass[My Wonderfull title, John Doe Jr., Brocku U, final]{beamer}
...
\setlength{\paperheight}{42 in} % A0 height: 33.1in
...
\title{My Wonderfull title} % Poster title

\author{John Doe Jr.} % Author(s)

\institute{Brocku U} % Institution(s)
