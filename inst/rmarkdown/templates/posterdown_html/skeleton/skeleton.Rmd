...
```{r, mymapfig, out.width="100%", cache=TRUE, fig.cap='Map of Long Lake eample from the [ggspatial](https://github.com/paleolimbot/ggspatial) package.'}
library(ggplot2)
library(ggspatial)
...
Look at this animation!!!! Figure \@ref(fig:gganimatefig).
