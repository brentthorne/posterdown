...
\begingroup
  ...
  \color{titletextcol}
\vspace{0.5in}
  {\myfont \Huge{Using \texttt{posterdown} to generate reproducible conference posters
via RMarkdown \textgreater{} Knitr \textgreater{} Markdown
...
{\centering \includegraphics[width=1\linewidth]{skeleton_files/figure-latex/unnamed-chunk-2-1} 

}

\caption{Here is an example of a firgure using the iris dataset and ggplot2}\label{fig:unnamed-chunk-2}
\end{figure}
